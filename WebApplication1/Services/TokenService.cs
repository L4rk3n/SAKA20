...
namespace SAKA20_API.Services
{
    public class TokenService
    {
        ...
        public string GenerateJwt(Utilisateur member)
        {
            ...
            IEnumerable<Claim> claims = new List<Claim>()
            {
                ...
                new Claim("IdUtilisateur",member.IDutilisateur.ToString()),
                new Claim("isAdmin", member.Admin.ToString().ToLower()),
                new Claim("isActivated", member.Activated.ToString().ToLower()),
                new Claim("isCancelled", member.Cancelled.ToString().ToLower())
